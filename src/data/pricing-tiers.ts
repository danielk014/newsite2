...
export const pricingTiers: PricingTier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Personal Brand Lab (with editing tutorials)",
      "Personal Brand Long Form (with editing tutorials)",
      "Personal Brand Short Form (with editing tutorials)",
      "Faceless AI Short Form Content (with editing tutorials)",
      "Faceless Clipping Course (with editing tutorials)",
      "Monetization Course",
