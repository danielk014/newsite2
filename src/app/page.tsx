    ...
    <div className="min-h-screen overflow-x-hidden"
      ...
      <section className="py-8 md:py-12 lg:py-18 bg-gradient-to-r from-primary/10 to-accent/10 overflow-hidden">
        ...
        <div className="relative overflow-hidden w-full">
            {/* Mobile Version - Rebuilt with proper mobile sizing */}
            <div className="block md:hidden">
              <div className="relative overflow-hidden py-4">
                <div className="flex animate-mobile-infinite space-x-6 will-change-transform">
                  {/* Leading images */}
                  <div className="flex-shrink-0 bg-card border-2 border-border rounded-xl p-3 shadow-lg w-80">
                    <Image 
